...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Jan 2033 17:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Jan 2033 17:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Jan 2033 17:00:00.000000000
        Stop		 1 Jan 2034 17:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jan 2033 17:00:00.000000000
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 15 Apr 2020 17:00:00.000000000
                    Stop		 16 Apr 2020 17:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<VAR name = "STK_Radar_Clutter_Extension">
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Jan 2033 17:00:00.000000000
                EndTime		 1 Jan 2034 17:00:00.000000000
                CurrentTime		 21 Jan 2033 02:44:44.173000000
                Direction		 Reverse
                UpdateDelta		 180
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Facility/Apollo11
            Facility/Apollo11		
        END Instance
        Instance Facility/Apollo12
            Facility/Apollo12		
        END Instance
        Instance Facility/Apollo14
            Facility/Apollo14		
        END Instance
        Instance Facility/Apollo15
            Facility/Apollo15		
        END Instance
        Instance Facility/Apollo16
            Facility/Apollo16		
        END Instance
        Instance Facility/Apollo17
            Facility/Apollo17		
        END Instance
        Instance Facility/ArtemisLM
            Facility/ArtemisLM		
        END Instance
