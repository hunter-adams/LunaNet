...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Jan 2024 18:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Jan 2024 18:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Jan 2024 18:00:00.000000000
        Stop		 1 May 2024 18:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jan 2024 18:00:00.000000000
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -1.23206e+08
            LaunchWindowStop		 -1.33574e+08
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 5 Feb 2020 18:00:00.000000000
                    Stop		 6 Feb 2020 18:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
        ...
        BEGIN Desc
            BEGIN LongText
LunaNet stationkeeping simulation; meant to confirm/complement the stationkeeping requirements matlab script.
            END LongText
        END Desc
...
<VAR name = "STK_Radar_Clutter_Extension">
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Jan 2024 18:00:00.000000000
                EndTime		 1 May 2024 18:00:00.000000000
                CurrentTime		 2 Jan 2024 07:30:00.000000000
                Direction		 Forward
                UpdateDelta		 1800
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Satellite/LunaNet1
            Satellite/LunaNet1		
            Satellite/LunaNet1/Antenna/Antenna1		
        END Instance
        Instance Satellite/LunaNet1/Antenna/Antenna1
            Satellite/LunaNet1/Antenna/Antenna1		
        END Instance
    END References
