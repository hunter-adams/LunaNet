% LunaNet_TradespaceExploration
% Written by Hunter Adams
% AERO 402 - Spring 2020
clc;clear;close all;

% The purpose of the following code is to explore the differing Consumer
% Off the Shelf (COTS) or In-House Components for each subsystem 
% of the LunaNet Cubesat, check them against the sytem requirements and 
% draw conclusions concerning various mission factors and part selections.
...
LunaNet_struct.power_modules(1) = nano_27sp;
LunaNet_struct.power_modules(2) = enduro_PM1P;
LunaNet_struct.power_modules(3) = enduro_PM2;
LunaNet_struct.power_modules(4) = isis_mesp;
...
ih20p_rec.antenna_pointing_loss = 2; % dB
ih20p_rec.circuit_loss = 0.1; % dB
ih20p_rec.noise_temperature_system = 350; % K
